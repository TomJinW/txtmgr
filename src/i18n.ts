...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    "ai.defaultGamePrompt": "Default Game Prompt",
    "ai.defaultVideoPrompt": "Default Video Prompt",
    ...
    "ai.fakeTranslate": "Fake Translate",
    ...
    "ai.baseUrlRequired": "Base URL is required for real translation.",
    "ai.modelRequired": "Model is required for real translation.",
    "ai.failedReadAttachment": "Failed to read attachment file.",
    "ai.startingFakeTranslation": "Starting fake translation...",
    "ai.startingAiTranslation": "Starting AI translation...",
    "ai.fakeTranslatingRow": "Fake translating row",
    ...
    "ai.fakeStoppedBeforeRow": "Fake translation stopped before this row.",
  ...
  "zh-Hans": {
    ...
    "ai.baseUrlRequired": "真实翻译需要填写 Base URL。",
    "ai.modelRequired": "真实翻译需要填写模型。",
    "ai.failedReadAttachment": "读取附加文件失败。",
    "ai.startingFakeTranslation": "正在启动假翻译...",
    "ai.startingAiTranslation": "正在启动 AI 翻译...",
    "ai.fakeTranslatingRow": "正在假翻译第",
    ...
    "ai.fakeStoppedBeforeRow": "假翻译在这一行之前停止。",
